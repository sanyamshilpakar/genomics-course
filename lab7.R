...
## ----dir----------------------------------------------------------------------
# finds the directory where R packages store external data which is a part of the airway package.

dir <- system.file("extdata", package="airway", mustWork=TRUE)

## ----list.files---------------------------------------------------------------
# list the number of files in a directory. In this case, its 8 bam files
...
## ----makecoldata--------------------------------------------------------------
# focus on two directories that are in quants directory
...
## ----assaysgse----------------------------------------------------------------
# we investigate the SummarizedExperiment object by looking at matrices of 
# assays slot, phenotypic data about sample (colData) slot, and data about the 
# gene in rowRanges slot.
...
## ----rowrangesgse-------------------------------------------------------------
# shows ranges for first 5 and last 5 genes.
...
## ----renamelevels-------------------------------------------------------------
# converst the condition variables into untrt and trt respectively
...
## -----------------------------------------------------------------------------
# countdata is a table w fragment counts $ coldata is table w info abt samples
